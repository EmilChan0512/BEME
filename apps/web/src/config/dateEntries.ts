...
export const dateEntries: DateEntry[] = [
  {
    ...
    note:
      '原本站点还是通用企业模板，今天先把方向掰正成 daily log。接下来每一天都可以是一张独立页面，像在时间轴上留下一个截面。',
    highlights: [
  ...
  },
  {
    ...
    note:
      '今天主要在头部细节上来回调整透明度、模糊和高光层次。玻璃感不是单靠背景透明，而是要靠前景高光、阴影和页面背景一起配合。',
    highlights: [
  ...
  },
  {
    ...
    note:
      '这一步虽然不显眼，但对长期写作站点很重要。页面会越来越多，如果样式还堆在一个文件里，很快就会失控。',
    highlights: [
  ...
  },
  {
    ...
    note:
      '个人网站不一定要复杂，但有节奏感会让浏览体验更像翻阅日志。今天保留了转场系统，为之后的每日页面切换继续服务。',
    highlights: [
...
export function getDateEntry(date: string) {
